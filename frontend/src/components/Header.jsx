            ...
            <nav className="flex space-x-8">
              {[
                ...
                <Link 
                  key={item.path}
                  to={item.path} 
                  className={`relative px-4 py-2 font-semibold transition-all duration-300 hover:text-white group rounded-lg hover:bg-white/10 ${
                ...
                >
                  ...
                  <div className={`absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-white to-gray-300 group-hover:w-full transition-all duration-500 ${
              ...
              {[
                ...
                <Link 
                  ...
                  className={`flex items-center space-x-3 px-6 py-4 text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-300 rounded-xl mx-4 transform hover:translate-x-2 ${
                    location.pathname === item.path ? 'text-white bg-white/10 translate-x-2' : ''
                  }`}
                >
