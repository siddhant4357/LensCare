    ...
    <footer className="bg-black text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4">LensCare</h3>
            <p className="text-gray-300">Your vision, our priority. Quality eye care and premium optical products.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/products" className="text-gray-300 hover:text-white">Frames</Link></li>
